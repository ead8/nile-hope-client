...
const Card = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url(" https://nile-hope-client.vercel.app/images/banner/card.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                ...
                <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90] mx-auto py-16'>
                    {
                        card_products.length > 0 || outofstock_products.length > 0 ? <div className='flex flex-wrap'>
                            ...
                            <Link className='px-4 py-1 bg-gray-800 text-white' to='/shops'>Shop Now</Link>
                        </div>
                    }
                </div>
            </section>

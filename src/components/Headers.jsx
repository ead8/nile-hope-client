...
const Headers = () => {
    ...
    return (
        <div className='w-full bg-white'>
            ...
            <div style={{ backgroundColor: 'rgb(187, 235, 151)' }} className='header-top flex justify-between'>
                ...
                <div className='w-[85%] lg:w-[90%] mx-auto'>
                    <div className='flex w-full justify-between items-center h-[80px] text-black'>
                        ...
                        <div className='flex justify-end gap-4 ml-auto'>
                            <a 
                                target='_blank'
                                href='https://nile-hope-dashboard.vercel.app/'
                            ...
                            <div className="link cursor-pointer text-blue-600 hover:text-green-200">
                                <div onClick={() => userInfo ? navigate('/dashboard/return-products') : navigate('/login')} className={`pb-0 block text-sm font-bold md-lg:hidden ${pathname === '/returns' ? 'text-[rgb(59,57,173)]' : 'text-black'}`}>Returns</div>
                                <div onClick={() => userInfo ? navigate('/dashboard/return-products') : navigate('/login')} className={`p-1 block text-sm font-bold md-lg:hidden ${pathname === '/returns' ? 'text-[rgb(59,57,173)]' : 'text-black'}`}>& Orders</div>
                            </div>
                            <div className='justify-center md:mr-3 items-center w-[30px] h-[30px] text-slate-600 border border-slate-600 rounded-sm cursor-pointer lg:hidden md-lg:flex xl:hidden hidden' onClick={() => setShowShidebar(false)}>
                                <span><FaList /></span>
                            </div>
                        </div>
                    </div>
            ...
            <div className='bg-white mb-3'>
                <div className='w-[95%] lg:w-[98%] mx-auto'>
                    <div className='h-[60px] sm:h-[40px] md-lg:h-[100px] flex justify-end items-center flex-wrap'>
                
                        <div className="w-6/12 md-lg:w-full flex justify-end items-center">
                            <div className='flex border items-center h-[40px] sm:mt-2 w-full relative gap-5 rounded-r-md'>
                        ...
                        <div className='md-lg:w-full w-3/12 flex justify-end items-center'>
                            ...
                            <div className='flex gap-5 sm:hidden'>
                                <div onClick={()=>navigate(userInfo ? '/dashboard/my-wishlist' : '/login')} className='relative flex justify-center items-center cursor-pointer w-[35px] h-[35px] border border-black rounded-full bg-white'>
                                    <span className='text-xl text-[#bbeb97]'><AiFillHeart /></span>
                                    {wishlist_count !== 0 && 
                                        <div className='w-[20px] h-[20px] absolute bg-[#bbeb97] rounded-full text-white flex justify-center items-center -top-[3px] -right-[5px]'>
                                            {wishlist_count}
                                        </div>
                                    }
                                </div>
                                <div onClick={redirect_card_page} className='relative flex justify-center items-center cursor-pointer w-[35px] h-[35px] border border-black rounded-full bg-white'>
                                    <span className='text-xl text-[#bbeb97]'><AiOutlineShoppingCart /></span>
            ...
            <div className='hidden md-lg:block'>
                ...
                <div className={`w-[300px] z-[9999] transition-all duration-200 fixed  ${showShidebar ? '-left-[300px]' : 'left-0'} top-0 overflow-y-auto bg-white h-screen py-0 px-0`}>
                    <div className='flex justify-start flex-col gap-6'>
                        <div style={{ backgroundColor: 'rgb(187, 235, 151)' }} className='w-full mx-0'>
                        <Link to='/'>
                            <img src=" https://nile-hope-client.vercel.app/images/nile-logo.png" alt="logo" />
                        </Link>
                        </div>
                        <div className='flex justify-star items-center gap-10 px-4'>
                            <a 
                                target='_blank'
                        ...
                        <ul className='flex flex-col justify-start items-start  text-md px-4 font-semibold uppercase'>
                            <li>
                                <Link to='/' className={`py-2 block ${pathname === '/' ? 'text-[#7fad39]' : 'text-slate-600'}`}>Home</Link>
                            </li>
                            <li>
                                <Link to='/returns' className={`py-2 block ${pathname === '/returns' ? 'text-[#7fad39]' : 'text-slate-600'}`}>Returns & Orders</Link>
                            </li>
                            <li>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            <div className='w-[48px] h-[48px] px-2 rounded-full flex bg-[#f5f5f5] justify-center items-center'>
                                <a href='tel:+251938817656'>
                                <span><IoIosCall /></span>
                                </a>
                            </div>
                        ...
                        <ul className='flex flex-col justify-start items-start gap-3 px-3 text-[#1c1c1c]'>
